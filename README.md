...
| 26.2 | `26.2/` | `26.2/target/Nyx-26.2+1.2.1.jar` | `26.2.build.111-stable` | 2.13.0 |
...
Each shaded jar is output to its module's `target/` folder (e.g. `1.21.6/target/Nyx-1.21.6+1.2.1.jar`). Building the **26.2** module requires **JDK 25** (the 1.21.x modules compile to Java 21 bytecode, but are built with the same JDK). Requires Maven 3.9+.
